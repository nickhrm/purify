...
def analyze_fidelity_dependency(
    coherence_time=0.08, output_file="fidelity_analysis.csv"
):
    model_path = "results/best/best_models_5gps_03_00_00_2/0_001/best_model.zip"
    ...
    fidelities = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0] # 1.0 ergänzt
    ...
    for fid in fidelities:
        ...
        obs = np.array([fid, 0.0, 0.00, 0.3, 0.0, 0.0], dtype=np.float32)
...
if __name__ == "__main__":
    ...
    for t in [0.01, 0.05, 0.1]:
        analyze_fidelity_dependency(coherence_time=t)